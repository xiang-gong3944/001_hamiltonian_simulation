...
BENCHMARK_COLUMNS = (
    ...
    "empirical_stability_diagnostics_json",
    "empirical_external_validation_sizes_json",
    "empirical_external_validation_status",
    "empirical_precision_backend",
    "empirical_precision_digits",
    "package_version",
    "python_version",
    "qiskit_version",
    "git_commit",
